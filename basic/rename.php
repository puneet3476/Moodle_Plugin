...
<body class="gradient">
      ...
      <form method="POST" action="rename_video.php" role="form">
          <input type="text" name="video_name" value="<?php echo($video_name) ?>" style="display: none;">
          <input type="text" name="database_name" value="<?php echo($database_name) ?>" style="display: none;">
