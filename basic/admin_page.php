...
<h2 class="welcome text-center text-light">Create a new Course</h2>
...
<br>
<h6 align="center" style="color:white">Warning! Give a short and unique course name, otherwise your previous courses or data may get deleted.</h6>
<br>
