...
<body style="overflow-y: scroll;">
  ...
  >
    ...
    <script type="text/javascript">
      ...
      var loginLink = document.querySelector('#login_but');
      if (loginuser == "empty1") {
    ...
    play:function (letbool) {
              ...
              var vid_curenttime = this.timeConvert(vid_curenttimesecond);
              var play = 0;
              var pause = 0;
              var playpause = 1;
              var loginbool = document.getElementById("loginbool").innerHTML;
    ...
    onvolumechange: function() {
              var volumechange = 1;
              var vid_curenttime = this.timeConvert(player.currentTime);
