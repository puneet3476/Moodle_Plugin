...
function graphtime(count) {search=[];
        ...
        var vid_curenttimesecond=Math.round(document.getElementById('myVideo').currentTime);
          ...
          var vid_curenttime_max=Math.floor((vid_div+vid_curenttimesecond));
            ...
            for (var j =0;  j<=fruits.length-1; j++) {
              if(i==fruits[j]){document.getElementById('myVideo').currentTime=fruits[j];
      ...
      function searchbar(values){var found = 'false';
    ...
    for (i = 0; i < x.length; i++) {
      ...
      function graphtimeConvert(time){var vid_div=vid_t/20;
  ...
  <div class="chatbox" id="mydiv">
    <div class="chatbox_upbar">
      ...
      <div class="dropdown_btn" id="ddb"><div class="dropdown_logo"></div></div>
            ...
            <i class="fas fa-bars" style="position: absolute;top: 7px;left: 2%;"></i>
      ...
      <div><select class="sort_method con" id="sort_method"  >
            ...
            <i class="fas fa-caret-down " style="left: 55%;top: 8px;position: absolute;"></i>
        </div>
...
current_react:current_react
  ...
  lastelementy.scrollIntoView({ behavior: 'smooth', block: 'nearest',inline:'nearest'});
   }
  })
    ...
    <div class="chatbox_downbar" id="log">
      ...
      <div class="comment_insight" id="ilb" style="display:<?php echo (empty($_SESSION['loginname'])) ? 'block' : 'none'; ?>">+</div>
        <input class="commentarea topicy" type="text" required="required" name="comment" placeholder="Comment here" >
        <button class="post_btn submitposty" id="submitposty" type="submit" ><i class="fas fa-location-arrow"></i></button>
        <input class="commentarea topicy" type="text" required="required" name="comment" placeholder="Comment here" >
        <button class="post_btn submitposty" id="submitpost" type="submit" ><i class="fas fa-location-arrow"></i></button>
    </div>
  </span>
</div>
</div>
