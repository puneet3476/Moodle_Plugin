...
<div class="container">
	...
	<video playsinline controls class="vidchaVideo" id="myVideo" preload="metadata" width="880" height="495" style="--plyr-color-main:#e82c2f;--plyr-video-control-background-hover:rgba(0,0,0,0);--plyr-video-control-color:white;" >
